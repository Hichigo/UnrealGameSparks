...
// also disable on Android, because of a crash in mpi_sub_hlp when compiling with -O3
// this needs to be re-evaluated once we upgrade mbed-TLS
#if !defined(__ANDROID__) && (!defined(__arm__) || defined(__ARM_ARCH_7A__))
