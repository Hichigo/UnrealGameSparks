			...
			*/
			class AchievementEarnedMessage : public GSMessage
			{
				public:
					...
					AchievementEarnedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeAcceptedMessage : public GSMessage
			{
				public:
					...
					ChallengeAcceptedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeChangedMessage : public GSMessage
			{
				public:
					...
					ChallengeChangedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeChatMessage : public GSMessage
			{
				public:
					...
					ChallengeChatMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeDeclinedMessage : public GSMessage
			{
				public:
					...
					ChallengeDeclinedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeDrawnMessage : public GSMessage
			{
				public:
					...
					ChallengeDrawnMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeExpiredMessage : public GSMessage
			{
				public:
					...
					ChallengeExpiredMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeIssuedMessage : public GSMessage
			{
				public:
					...
					ChallengeIssuedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeJoinedMessage : public GSMessage
			{
				public:
					...
					ChallengeJoinedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeLapsedMessage : public GSMessage
			{
				public:
					...
					ChallengeLapsedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeLostMessage : public GSMessage
			{
				public:
					...
					ChallengeLostMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeStartedMessage : public GSMessage
			{
				public:
					...
					ChallengeStartedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeTurnTakenMessage : public GSMessage
			{
				public:
					...
					ChallengeTurnTakenMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeWaitingMessage : public GSMessage
			{
				public:
					...
					ChallengeWaitingMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeWithdrawnMessage : public GSMessage
			{
				public:
					...
					ChallengeWithdrawnMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ChallengeWonMessage : public GSMessage
			{
				public:
					...
					ChallengeWonMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class FriendMessage : public GSMessage
			{
				public:
					...
					FriendMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class GlobalRankChangedMessage : public GSMessage
			{
				public:
					...
					GlobalRankChangedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class MatchFoundMessage : public GSMessage
			{
				public:
					...
					MatchFoundMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
				...
				/// </summary>
					// method type 4
					GameSparks::Core::GSData::t_Optional GetPendingMatchData () const
					{
						return m_Response.GetGSDataObject("pendingMatchData");
					}
				/// <summary>
			...
			*/
			class MatchNotFoundMessage : public GSMessage
			{
				public:
					...
					MatchNotFoundMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class MatchUpdatedMessage : public GSMessage
			{
				public:
					...
					MatchUpdatedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class NewHighScoreMessage : public GSMessage
			{
				public:
					...
					NewHighScoreMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class NewTeamScoreMessage : public GSMessage
			{
				public:
					...
					NewTeamScoreMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class ScriptMessage : public GSMessage
			{
				public:
					...
					ScriptMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class SessionTerminatedMessage : public GSMessage
			{
				public:
					...
					SessionTerminatedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class SocialRankChangedMessage : public GSMessage
			{
				public:
					...
					SocialRankChangedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class TeamChatMessage : public GSMessage
			{
				public:
					...
					TeamChatMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class TeamRankChangedMessage : public GSMessage
			{
				public:
					...
					TeamRankChangedMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
			...
			*/
			class UploadCompleteMessage : public GSMessage
			{
				public:
					...
					UploadCompleteMessage(const GameSparks::Core::GSData& data)
					: GSMessage(data)
					{
