		...
		*/
		...
		class GSTypedRequest 
		{
			...
			public:
				...
				/// send this request to the server. Use this for fire and forget Requests.
				virtual void Send(Seconds timeoutSeconds=0)
				{
					m_Request.Send(timeoutSeconds);
				}
				...
				virtual void Send(t_ResponseCallback callback, Seconds timeoutSeconds=0)
				{
				...
				virtual void Send(t_ResponseCallback successCallback, t_ResponseCallback errorCallback, Seconds timeoutSeconds=0)
				{
				...
				/// <summary>
				/// Sets the playerId for this request.
				...
				/// </summary>
				GSTypedRequest<RequestType, ResponseType>& SetPlayerId(const gsstl::string& playerId)
				{
